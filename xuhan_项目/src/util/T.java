...
public class T {
	...
	private String sendAddr = "470636603";//这是发送方的邮箱
	private String receiveAddr = "1134181554";//接收方的邮箱

	//这个不是密码,是开启163邮箱第三方登录时候设置的授权码
	//如果不开启,那么是无法第三方登录163邮箱账号的
	private String pass = "开启第三方登录时的授权码";
...
//		prop.put("mail.transport.protocol", "smtp");
		...
		//设置收件人
		msg.setRecipients(Message.RecipientType.TO,"1134181554@qq.com");
...
//		msg.setRecipients(Message.RecipientType.BCC,"偷偷的发@163.com");
	...
	public void t2() throws Exception{
		...
		msg.setFrom(new InternetAddress(sendAddr+"@qq.com"));
		// 设置收件人
		msg.setRecipients(Message.RecipientType.TO, receiveAddr+"qq.com");
